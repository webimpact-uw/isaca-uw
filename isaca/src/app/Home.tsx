      ...
      <section className="grid md:grid-cols-2 items-end gap-8">
          <div>
            ...
            <div className="mt-3 flex items-center space-x-4">
              <h3 className="text-2xl">ISACA UW Chapter</h3>

              <div className="inline-flex items-center bg-lightest-blue rounded-full px-4 py-2">
                <img src="icons/ischool.png" alt="iSchool Logo" className="w-6 h-6 mr-4" />

                <Link href='https://ischool.uw.edu/programs/informatics/community'>
                  <span className="text-lg font-medium text-navy-blue">
